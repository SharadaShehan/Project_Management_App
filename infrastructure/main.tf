...
# Cognito Module (depends on Lambda triggers)
module "cognito" {
  source = "./modules/cognito"

  project_name                   = var.project_name
  environment                    = var.environment
  pre_signup_lambda_arn          = module.lambda.cognito_pre_signup_arn
  post_confirmation_lambda_arn   = module.lambda.cognito_post_confirmation_arn
