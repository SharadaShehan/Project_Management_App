...
locals {
  ...
  lambda_functions = {
    ...
    # Forum resolvers
    "forum-create-post"        = { handler = "forum/createPost.handler", description = "Create forum post resolver" }
    "forum-get-post"           = { handler = "forum/getPost.handler", description = "Get forum post resolver" }
    "forum-update-post"        = { handler = "forum/updatePost.handler", description = "Update forum post resolver" }
    "forum-delete-post"        = { handler = "forum/deletePost.handler", description = "Delete forum post resolver" }
    "forum-list-posts"         = { handler = "forum/listPosts.handler", description = "List forum posts resolver" }
